...
using vec3 = gpw::vma::vec<3>;
using mat3 = gpw::vma::mat<3, 3>;
using se3  = gpw::vma::vec<6>;
using so3  = gpw::vma::vec<3>;
...
SE3
expm (const double, const double, const double, const double, const double, const double);
SE3
...
bool
operator== (const SE3&, const gpw::vma::mat<4, 4>&);

bool
operator== (const gpw::vma::mat<4, 4>&, const SE3&);
...
bool
similar (const SO3&, const SO3&, const double tol = std::numeric_limits<double>::epsilon());

bool
similar (const SE3&, const SE3&, const double tol = std::numeric_limits<double>::epsilon());
